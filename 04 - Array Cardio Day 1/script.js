...
const filteredInventors = inventors.filter(i => i.year >= 1500 && i.year < 1600)
console.log('Filtered inventors')
console.table(filteredInventors)

// Array.prototype.map()
// 2. Give us an array of the inventors' first and last names
const mappedInventors = inventors.map(i => `${i.first} ${i.last}`)
console.log('Mapped Inventors', mappedInventors)

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
const sortedInventors = inventors.sort((i1, i2) => i1.year - i2.year)
...
console.log('Total age', reducedInventors)

// 5. Sort the inventors by years lived
const ageSortedInventors = inventors.sort((i1, i2) => i1.passed - i1.year - i2.passed + i2.year)
console.log('Inventos sorted by age')
