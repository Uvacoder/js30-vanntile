...
Object.defineProperty(exports, "__esModule", { value: true });
var on_next_frame_1 = __webpack_require__(35);
var create_render_step_1 = __webpack_require__(36);
...
var value_1 = __webpack_require__(38);
exports.value = value_1.default;
var decay_1 = __webpack_require__(39);
...
var physics_1 = __webpack_require__(40);
exports.physics = physics_1.default;
var spring_1 = __webpack_require__(41);
exports.spring = spring_1.default;
var timeline_1 = __webpack_require__(42);
...
var crossfade_1 = __webpack_require__(44);
...
var schedule_1 = __webpack_require__(46);
exports.schedule = schedule_1.default;
var stagger_1 = __webpack_require__(47);
...
var stylefire_1 = __webpack_require__(48);
...
var composite_1 = __webpack_require__(11);
var parallel_1 = __webpack_require__(9);
var transformers_1 = __webpack_require__(5);
...
var render_1 = __webpack_require__(49);
...
var _Parts = __webpack_require__(32);

var _popmotion = __webpack_require__(4);

(0, _popmotion.chain)(_Parts.backgroundCircle, _Parts.body, (0, _popmotion.composite)({
  hair: _Parts.hair,
  tail: _Parts.tail
}), _Parts.eye, _Parts.horn).start();
...
var _backgroundCircle = __webpack_require__(33);

Object.defineProperty(exports, 'backgroundCircle', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_backgroundCircle).default;
  }
});

var _horn = __webpack_require__(52);

Object.defineProperty(exports, 'horn', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_horn).default;
  }
});
...
var _tail = __webpack_require__(56);
...
var _hair = __webpack_require__(58);

Object.defineProperty(exports, 'hair', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_hair).default;
  }
});

var _eye = __webpack_require__(60);
...
var _backgroundCircle = __webpack_require__(34);
...
var mainSvg = document.getElementById('main-svg'); /* START: Fill Here */

var backgroundCircle = document.createElementNS('http://www.w3.org/2000/svg', 'circle');
mainSvg.prepend(backgroundCircle);

var backgroundCircleStyler = (0, _popmotion.styler)(backgroundCircle);
...
var animateBackground = (0, _popmotion.tween)({
  from: { r: 0 },
  to: { r: 100 },
  duration: 500
});

exports.default = (0, _popmotion.action)(function (_ref) {
  var complete = _ref.complete;
  return animateBackground.start({ update: backgroundCircleStyler.set, complete: complete });
});
/* END: Fill Here */
...
var _horn = __webpack_require__(53);
...
var path = 'M 90.65,15.04 C 91.61,15.65 84.09,30.17 83.74,30.22 81.52,30.43 79.30,29.26 78.74,28.09 78.78,28.00 89.70,14.43 90.65,15.04 Z';

var mainSvg = document.getElementById('main-svg');
var subSvg = mainSvg.getElementById('drawing');
var horn = document.createElementNS('http://www.w3.org/2000/svg', 'path');
subSvg.appendChild(horn);

var hornStyler = (0, _popmotion.styler)(horn);
hornStyler.set({
  /* START: Fill Here */
  fill: 'aquamarine',
  /* END: Fill Here */
...
var animateHorn = (0, _popmotion.tween)({
  /* START: Fill Here */
  from: {
    x: -20,
    y: 30,
...
exports.default = (0, _popmotion.action)(function (_ref) {
  var complete = _ref.complete;
  return animateHorn.start({ update: hornStyler.set, complete: complete });
});
...
var bodyStyler = (0, _popmotion.styler)(bodyPath);
/* START: Fill Here */
...
var drawBody = (0, _popmotion.tween)({
  from: { 'stroke-dashoffset': 220, opacity: 1 },
  to: { 'stroke-dashoffset': 440 },
  duration: 2000
});

var fillBody = (0, _popmotion.tween)({
  from: { fillOpacity: 0 },
  to: { fillOpacity: 1 },
  duration: 500
});

var animateBody = (0, _popmotion.chain)(drawBody, fillBody);
/* END: Fill Here */

/* START: Update Here */
exports.default = (0, _popmotion.action)(function (_ref) {
  var complete = _ref.complete;
  return animateBody.start({ update: bodyStyler.set, complete: complete });
});
/* END: Update Here */
...
var _tail = __webpack_require__(57);
...
var tailStyler = (0, _popmotion.styler)(tail);
tailStyler.set({
  /* START: Fill Here */
  fill: 'pink',
  /* END: Fill Here */
...
var animateTail = (0, _popmotion.tween)({
  /* START: Fill Here */
...
exports.default = (0, _popmotion.action)(function (_ref) {
  var complete = _ref.complete;
  return animateTail.start({ update: tailStyler.set, complete: complete });
});
...
var _hair = __webpack_require__(59);
...
var hairStyler = (0, _popmotion.styler)(hair);
hairStyler.set({
  /* START: Fill Here */
  fill: 'lavender',
  /* END: Fill Here */
...
var animateHair = (0, _popmotion.tween)({
  /* START: Fill Here */
...
exports.default = (0, _popmotion.action)(function (_ref) {
  var complete = _ref.complete;
  return animateHair.start({ update: hairStyler.set, complete: complete });
});
...
var _eye = __webpack_require__(61);
...
var eyeStyler = (0, _popmotion.styler)(eye);
eyeStyler.set({
  opacity: 0,
  /* START: Fill Here */
  fill: 'black',
...
var showEye = (0, _popmotion.tween)({
  /* START: Fill Here */
...
/* START: Fill Here */
var blinkEye = (0, _popmotion.tween)({
  from: { scaleY: 1 },
  to: { scaleY: 0.1 },
  duration: 50,
  flip: 1
...
/* START: Update Here */
exports.default = (0, _popmotion.action)(function (_ref) {
  var _complete = _ref.complete;

  showEye.start({ update: eyeStyler.set, complete: function complete() {
      _complete();
      setInterval(function () {
        return blinkEye.start({ update: eyeStyler.set });
      }, 2000);
    } });
});
/* END: Update Here */
